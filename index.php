...
<body class="d-flex flex-column min-vh-100">
	...
	<div class="main-content mx-auto">
		<h1> LIAR'S DICE </h1> <br>
		<div class="button-cls w-50 mx-auto"> 
			<button type="button" class="btn btn-secondary btn-lg"> <a href="tc.php" class="change"> SinglePlayer </a> </button><br><br>
			<button type="button" class="btn btn-secondary btn-lg"> <a href="tcm.php" class="change"> MultiPlayer </a> </button><br><br>
			<button type="button" class="btn btn-secondary btn-lg"> <a href="htp.php" class="change"> How To Play </a> </button>
		</div>
