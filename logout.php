...
<body class="d-flex flex-column min-vh-100">
	...
	<div class="logout">
		<form method="POST">
				...
				<button type="submit" class="btn btn-danger" name="logout">Log out </button><br><br>
		</form>
	</div>
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		if(isset($_POST['logout'])){
			...
			unset($_SESSION['hasChecked']);
			unset($_SESSION['hasCheckedm']);
			unset($_SESSION['time1']);
			unset($_SESSION['time2']);
			unset($_SESSION['time11']);
			unset($_SESSION['time22']);
			unset($_SESSION['frtime2']);
			unset($_SESSION['frtime']);
